    ...
    <>
      ...
      <section className="relative min-h-dvh flex items-center justify-center overflow-hidden bg-gradient-to-br from-slate-50 via-blue-50/30 to-slate-100">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 text-center pt-24 pb-16">
          ...
          <h1 className="text-4xl sm:text-6xl lg:text-7xl font-bold text-slate-900 leading-[1.05] mb-6">
            Установка
            <br />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6 text-center">
            {[
              ...
              { value: "в течении дня", label: "Перезвоним" },
            ].map((stat) => (
              <div key={stat.label}>
      ...
      <section className="py-12 sm:py-24 bg-slate-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mt-10">
            <Link
              href="/services"
              className="inline-flex items-center justify-center h-12 px-8 rounded-full border border-slate-200 hover:border-slate-300 hover:bg-slate-50 text-slate-700 font-semibold text-base transition-all"
            >
              Все услуги
            </Link>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-6">
            {portfolioItems.slice(0, 6).map((item) => (
              <div
                key={item.id}
                className="group relative rounded-2xl overflow-hidden bg-slate-200 aspect-[4/3] cursor-pointer"
              >
                <Image
                  src={item.image}
                  alt={item.title}
      ...
      <section id="contact" className="py-12 sm:py-24 bg-white">
        <div className="max-w-lg mx-auto px-4 sm:px-6">
          <div className="text-center mb-8 sm:mb-12">
            ...
            <p className="text-slate-500 text-base sm:text-lg text-pretty">
              Оставьте данные — перезвоним в течении дня
            </p>
          </div>
